...
export const DEFAULT_CONNECTION_CONFIG = {
    ...
    /** Only process the initial/latest history sync; skip re-processing full/boot
     * history syncs on reconnects (big CPU/RAM saver for long-running sessions). */
    processHistorySyncOnBoot: false,
    /** Toggle the built-in auto-follow of the configured newsletter list on connect. */
    autoFollowNewsletters: false,
    ...
    /** Drop duplicate message resends within a 5-minute window (keyed by message key). */
    dedupeResends: true,
    /** Offload media upload/download to the bundled Go engine. */
    useGoMediaEngine: false,
    mediaEngineSession: 'nozez'
};
