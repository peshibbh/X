...
import { makeMessageDeduper } from '../Utils/message-dedup.js';
...
export const makeMessagesRecvSocket = (config) => {
    ...
    const dedupeResends = config.dedupeResends !== false;
    const messageDeduper = makeMessageDeduper();
    ...
    const handleMessage = async (node) => {
        ...
        try {
            ...
            await messageMutex.mutex(async () => {
                ...
                if (dedupeResends && messageDeduper.isDuplicate(msg)) {
                    logger.debug({ key: msg.key }, 'dropped duplicate message resend');
                    return;
                }
